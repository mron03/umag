        ...
        {submitted ? (
          ...
          <div className="flex items-center space-x-10">
            ...
            >
              ...
              {errors.price && <span className="block">Price is required</span>}
              <div className="flex flex-col">
              ...
              {errors.quantity && <span className="block">Quantity is required</span>}
              <div className="flex flex-col">
                <label className="text-sm font-medium">Time of {type ? "supply" : "sale"} </label>
                <input
                  type="datetime-local"
                  step={1}
              ...
              {errors.supplyTime && (
                <span className="block">{type ? "supply" : "sale"} time is required</span>
              )}
              <Button />
            </form>
          </div>
